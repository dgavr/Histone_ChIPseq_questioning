...
def find_1st_line():
    ...
    for line in wigfile: 
        if line.startswith('track'):
            first_line = 'track type=wiggle_0 name=20pt_'+line.split()[2].split('=')[1]+'maxHeightPixels=64:64:11 color=31,120,180 visibility=full \n'
            break
    wigfile.close()
    return first_line
...
if __name__ == "__main__":
    ...
    out_wig_filename = 'Minus_20pt_wig_'+wigfilename.split('.')[0]+'.wig'
    out_bed_filename = 'Minus_20pt_'+wigfilename.split('.')[0]+'.bed'
    ...
    out_bed.write('track name='+'Minus_20pt' + wigfilename.split('.')[0] + '\n')
