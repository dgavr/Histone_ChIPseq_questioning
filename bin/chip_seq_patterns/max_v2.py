...
if __name__ == "__main__":
    ...
    out_wig_filename = 'Better2_wig_'+wigfilename.split('.')[0]+'.wig'
    out_bed_filename = 'Better2_bed_'+wigfilename.split('.')[0]+'.bed'
    out_out_filename = 'Betterness2_'+wigfilename.split('.')[0]+'.out'
    ...
    for declaration_track, peak_intensity in read_wig(wig): #for each old 'peak'
        ...
        if (find_local_peak_throughs(peak_intensity)[0] == None) and (find_local_peak_throughs(peak_intensity)[1] == None): #if there are no local maxima or minima in the "peak"
            ...
            print declaration_track+ ' --> No min no max with scipy \n'
            no_max_no_min +=1 
            ...
            print 'New declaration track: '+ write_new_decl_track(declaration_track, new_start)+ '\n'
            ...
            dunno +=1 
            print 'I don\'t know what the hell this is.'+declaration_track + '\n'
            print peak_intensity       
    out_file.write('Went through file: '+ wigfilename + '\n')
    out_file.write('No maxima found:'+ str(multi_max)+'\n')
    out_file.write('No minima found:'+ str(multi_min) + '\n')
    out_file.write('Found no maxima and no minima in:'+ str(no_max_no_min) + '\n')
    out_file.write('Don\'t know what the hell this is:'+ str(dunno)+'\n')
